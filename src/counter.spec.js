...
describe('counter functions tests', () => {
  ...
  it(`after calling increaseCount 2 times for '${urlApi}' getCount should return 2`, () => {
    increaseCount(urlApi);
    increaseCount(urlApi);
    expect(getCount(urlApi)).toEqual(2);
  });
  it(`after calling clearCount for '${urlApi1}' getCount should return 0`, () => {
    increaseCount(urlApi1);
    increaseCount(urlApi1);
    clearCount(urlApi1);
    expect(getCount(urlApi1)).toEqual(0);
  });
  it(`function getCount for not set url - '${urlApi2}' should return 0`, () => {
